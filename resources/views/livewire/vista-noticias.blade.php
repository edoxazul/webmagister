...
{{-- <livewire:vista-noticias id="$noticia"> --}}
    ...
    <body class="font-sans antialiased">
        ...
        <div class="min-h-screen bg-gray-100">
            ...
            <div class="flex justify-center w-full px-2 mx-auto bg-gray-800 rounded-md max-w-7xl sm:px-6 lg:px-8">
                <a href= "{{ route('listanoticiaspublico') }}" class="justify-center px-3 py-3 text-sm font-medium text-center text-white rounded-md" > Volver </a>
            </div>
        ...
        <div class="flex items-center w-screen h-screen bg-gray-100">
            <div class="container flex flex-wrap items-center p-4 mx-auto">
              <div class="w-full p-4 text-center md:w-7/12 md:text-left">
                        ...
                        >Lo sentimos, esta página no está disponible. </p>
                    <button class="inline px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-blue-600 border border-transparent rounded-lg shadow focus:outline-none focus:shadow-outline-blue active:bg-blue-600 hover:bg-blue-700" ><a href= "{{ route('listanoticiaspublico') }}">Volver a noticias</a></button>
                    </div>
                    <div class="max-w-lg">
