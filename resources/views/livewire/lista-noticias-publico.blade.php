                            ...
                            <article class="overflow-hidden rounded-lg shadow-lg">
                                <div class="flex flex-wrap -mx-4">
                                    <div class="mr-5 bg-white blogs">
                                        <a class="" wire:click="showModal({{ $noticia->id }})"
                                           wire:loading.attr="disabled">
                                            <img src="{{ $noticia->noticia_photo_path }}"
                                                 class="block object-cover w-full h-44">
                                            <div class="p-10">
                                                <p class="text-sm text-gray-500 bg-white"> {{ $noticia->autor_noticia }}
                                                    | {{date("d/m/Y", strtotime($noticia->created_at))}}</p>
                                                ...
                                                <a href="{{ route('ver-noticia', ['id'=>$noticia->id])}}"
                                                   target="_blank"
                                                   class="inline-block px-3 px-6 py-2 mt-4 text-white bg-orange-500 rounded">Leer
                                                    más</a>
                                            </div>
                                        </a>
                                    </div>
